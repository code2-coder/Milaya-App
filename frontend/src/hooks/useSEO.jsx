...
export function useSEO(title, description, options = {}) {
  useEffect(() => {
    ...
    const defaultDesc = "Shop the latest emerging tech products, components, and gadgets safely from Milaya.";
    ...
    updateOrCreateMeta("description", description || "Discover premium clothing, exquisite dresses, tops, and traditional garments at Milaya.");
    updateOrCreateMeta("keywords", options.keywords || "clothing, apparel, premium, accessories, bottoms, outerwear, milaya");
